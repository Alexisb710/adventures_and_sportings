          ...
          <div className="row align-items-center g-5">
            <div className="col-md-6">
              <h1 className="mb-5 display-2">
                <strong>Best Adventure and Sportings Store</strong>
              </h1>
              <p>
                Find a large selection of adventure and sporting gear with
                popular brands and with affordable prices.
              </p>
            </div>
            <div className="col-md-6 text-center">
              <img src="/images/hero2.png" className="img-fluid" alt="hero" />
            </div>
          </div>
        </div>
      </div>
